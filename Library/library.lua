getgenv().toggleui = Enum.KeyCode.RightControl
...
function library:Window(uiname,TitleWhite,logoimage)
    if game.CoreGui:FindFirstChild("IllusionUi") then
        game.CoreGui:FindFirstChild("IllusionUi"):Destroy()
    end
    local IllusionUi = Instance.new("ScreenGui")
    ...
    IllusionUi.Name = "IllusionUi"
    IllusionUi.Parent = game:GetService("CoreGui")
    IllusionUi.DisplayOrder = 1
    MainUIFrame.Name = "MainUIFrame"
    MainUIFrame.Parent = IllusionUi
    ...
    BloxburgTitle1.BackgroundColor3 = Color3.fromRGB(24, 24, 24)
    ...
    UserInputService.InputBegan:Connect(function(input)
        if input.KeyCode == getgenv().toggleui then
            opened = not opened 
    ...
    local window = {}
    function window:Notification(content, callback)
            ...
            NotificationMain.Parent = IllusionUi
            ...
            NotificationTitle.Text = "Static Ware - Notification"
            NotificationTitle.TextColor3 = Color3.fromRGB(84, 116, 224)
            ...
            NotificationOkay.Text = callback
    ...
    function window:Tab(name)
        ...
        function tab:Section(name)
            ...
            function section:Keybind(name, default, callback)
                ...
                KeybindTitle.Position = UDim2.new(0.017783253, 0, 0, 0)
                ...
                KeybindValue.Position = UDim2.new(0.8, 0, 0.05, 0)
